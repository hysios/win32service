...
class Win32Service : node::ObjectWrap {
  ...
  public:
    ...
    // var notify = require("../build/default/Win32Service.node"); will bind our constructor function to notify.Notification
    ...
    static void Init(Handle<Object> target) {
      ...
      Win32Service::persistent_function_template->SetClassName(v8::String::NewSymbol("Notification"));
      
      // Set property accessors
      Win32Service::persistent_function_template->InstanceTemplate()->SetAccessor(String::New("title"), GetTitle, SetTitle);
      Win32Service::persistent_function_template->InstanceTemplate()->SetAccessor(String::New("icon"), GetIcon, SetIcon);
      ...
      target->Set(String::NewSymbol("notification"), Win32Service::persistent_function_template->GetFunction());
    }

    // new Notification();
    // This is our constructor function. It instantiate a C++ Win32Service object and returns a Javascript handle to this object.
    ...
    static v8::Handle<Value> Send(const Arguments& args) {
      ...
      // Notify::Notification n(Win32Service_instance->title.c_str(), *v8str, Win32Service_instance->icon.c_str()); // *v8str points to the C string
